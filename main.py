    ...
    def update(self):
        ...
        if self.counter>=60:
            ...
            if self.counter <= 12:
                print("HUNGER:")
                print("\t  [*]  ")
            elif self.counter>12 and self.counter<=24:
                print("HUNGER:")
                print("\t  [*][*]  ")
            elif self.counter>24 and self.counter<=36:
                print("HUNGER:")
                print("\t  [*][*][*] ")
            elif self.counter>36 and self.counter<=48:
                print("HUNGER:")
                print("\t  [*][*][*][*] ")
            elif self.counter>48 and self.counter<60:
                print("HUNGER:")
                print("\t  [*][*][*][*][*]")
                print("\t-occhio che muori di fame")
            print()
            self.player.draw_inventory()
            print()
            print("Azioni:")
